export const printSome = function (name, age) {
...
spread via commas.
*/
printSome.call({ status: 'single' }, 'Rose', 23);
// O/P: 'Rose is single at 23 years old.'
printSome.apply({ status: 'single' }, ['Rose', 23]);
// O/P: 'Rose is single at 23 years old.'
printSome.bind({ status: 'single' }, 'Rose', 23)();
// O/P: 'Rose is single at 23 years old.'

const boundPrint = printSome.bind({ status: 'unknown' }); // bind the context first
